class Field:
    ...
    def shrink_scaled_pos(self, pos):
        """Транслировать координаты в соответствии с размерами окна"""
        adjust_ratio = [
            self.settings.BASE_WINDOW_WIDTH / self.settings.window_width,
            self.settings.BASE_WINDOW_HEIGHT / self.settings.window_height,
        ]
